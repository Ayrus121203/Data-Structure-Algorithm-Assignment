...
def main():
    ...
    #---------------------------------------------------------------------------------------------------------------------------------------------
                    ...
                    user_range_sort_opt_accepable_opts = ['y', 'n']
                    while user_range_sort_opt not in user_range_sort_opt_accepable_opts:
                        print('Invalid Option')
                        user_range_sort_opt = input('Please enter Y or N: ').lower()
                    if user_range_sort_opt in user_range_sort_opt_accepable_opts:

                        if user_range_sort_opt == 'y':
                            print('Range Search Result will be sorted using Heap Sort')
                            print('')
